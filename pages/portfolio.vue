  ...
  <section class="w-full min-h-screen">
    ...
    <div class="w-5/6 lg:w-4/5 mx-auto text-black text-opacity-70">
      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-4 pt-3 pb-5">
        <img class="w-full h-[350px] object-cover cursor-pointer duration-500 hover:opacity-80" :src="require(`~/static/images/portfolio/portfolio${i}.jpg`)" :alt="`作品集${i}`" v-for="i in 72" :key="i" @click="viewPic(i)" data-aos="fade-up" data-aos-duration="1000">
      </div>
