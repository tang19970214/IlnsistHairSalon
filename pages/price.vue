<template>
  <section class="w-full min-h-screen">
    <div class="w-4/5 mx-auto text-black text-opacity-70">
      ...
      <div class="w-full grid grid-cols-1 md:grid-cols-2 gap-3 mg:gap-5">
        <!-- 消費特色 -->
        ...
        <div class="w-full py-3">
          ...
          <div class="w-full py-3">
            <ul class="list-none">
              <li>➊ 可採現金</li>
              <li class="flex items-center">➋ 刷信用卡<p class="text-primary text-sm ml-2">※不限金額且免手續費</p>
              </li>
      ...
      list: [
        {
          ...
          list: [
            "輕鬆無壓力、價格透明、輕消費",
            "所有項目都有包含免費洗髮",
            "所有價格皆與顧客確認完畢之後才開始操作，剪、染、燙髮皆包含基礎瞬間護髮",
            "不提供自備染膏及藥水的服務",
            "所有項目完全不分長短均一價",
          ],
