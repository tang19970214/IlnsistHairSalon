<template>
  <section class="w-full min-h-screen">
    <div class="w-full md:w-4/5 mx-auto text-black text-opacity-70">
      <!-- header -->
      <div class="w-full p-5 box-border bg-primary bg-opacity-60">
        <div class="w-full flex flex-col items-center justify-center bg-white p-5 rounded-lg">
          ...
          <div class="w-full mt-4 flex flex-col lg:flex-row items-center justify-center lg:justify-around text-gray-500">
            <div>放icon</div>
            <ul class="lg:text-lg tracking-wider">
              <li>簡單操作立刻預約</li>
              <li>詳細設計師群介紹</li>
              <li>首次加入領取100元禮卷</li>
            </ul>
      ...
      <!-- process -->
      <div class="w-full px-4 md:px-0 mt-6 mb-10 flex flex-col md:flex-row items-center gap-3">
